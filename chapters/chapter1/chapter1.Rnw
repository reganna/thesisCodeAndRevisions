...
Figure 1
<<Figure 1, echo=FALSE, message=FALSE, warning=FALSE, results='hide', out.width=350, out.height=350, cache=TRUE>>=
library(stylo)
...
Figure 2
<<Figure 2, echo=FALSE, warning=FALSE, out.width=250, out.height=250, cahce=TRUE>>=
...
Figure 3
<<Figure 3, echo=FALSE, warning=FALSE, out.width=250, out.height=250, cache=TRUE>>=
