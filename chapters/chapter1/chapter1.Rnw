...
<<Figure 2, echo=FALSE, warning=FALSE, out.width=250, out.height=250, cache=TRUE>>=
source('../../code/corpusFunctions.R')
par(mfrow=c(1, 2))
gutttr <- read.csv("../../preppedData/gut_ttr.csv")
...
library(zipfR)
traf_tfl <- read.tfl("../../tfls/isaacs_maria_colombia.txt.tfl")
maria_tfl <- read.tfl("../../tfls/marmol_amalia_argentina.txt.tfl")
...
traf.fzm.vgc <- lnre.vgc(traf.fzm, (1:230000), variances=TRUE)
