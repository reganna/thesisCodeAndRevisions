...
These autobiographical details, while not enough to redeem \textit{María} from its idyllic surroundings, do emphasize the importance of what Isaacs has omitted from the text. \todo[size=\tiny]{Segue to Mcgradys bio of him and Sommer and others 'displacement'}
...
Figure 1
<<Figure 1, echo=FALSE, message=FALSE, warning=FALSE, results='hide', out.width=350, out.height=350>>=
library(stylo)
stylo(gui = FALSE, mfw.min=1000, mfw.max=1000, corpus.lang="Spanish")
@
...
Figure 2
<<Figure 2, echo=FALSE, warning=FALSE, out.width=250, out.height=250>>=
source('~/Dropbox/laptop/Documents/thesis/code/corpusFunctions.R')

#par(mfrow=c(1, 2))

gutttr <- read.csv("~/Dropbox/laptop/Documents/thesis/preppedData/gut_ttr.csv")
plot(gutttr[,2], gutttr[,3], main = "TTR of Gutenberg Spanish Texts", xlab = "Types", ylab = "Tokens")
@


Figure 3
<<Figure 3, echo=FALSE, warning=FALSE, out.width=250, out.height=250>>=
ttr <- ttrDirectory("~/Dropbox/laptop/Documents/thesis/corpus/corpus")
author_names <- getAuthorNames("~/Dropbox/laptop/Documents/thesis/corpus/corpus")
plot(ttr, main = "TTR of Thesis Subcorpora", xlab= "Types", ylab = "Tokens")
text(ttr, labels=author_names)
@
...
For this reason, defining oneself linguistically became an important discussion amongst the elite of the burgeoning republics, a point to which I will return. \todo{this goes to the Lenguas book section}
