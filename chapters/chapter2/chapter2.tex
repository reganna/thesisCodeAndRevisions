...
Add discussion of hapax ratio



\begin{figure}
	\caption{}
	\label{fig:compareVgc}
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in file(file, "{}rt"{}): cannot open file '../../tfls/Galdos\_fontanaDeOro\_spain.txt.tfl': No such file or directory}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in file(file, "{}rt"{}): cannot open the connection}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in inherits(tfl, "{}tfl"{}): object 'font\_tfl' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in Vm(spc, 1): object 'font\_spc' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in inherits(model, "{}lnre"{}): object 'font.fzm' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot.vgc(maria.fzm.vgc, traf.fzm.vgc, amalia.fzm.vgc, font.fzm.vgc, : object 'font.fzm.vgc' not found}}\end{kframe}
\end{knitrout}
\end{figure}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): could not find function "{}sumalibrary"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): could not find function "{}compareSpcDir"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(hapax): object 'hapax' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in text(hapax, labels = rownames(hapax)): object 'hapax' not found}}\end{kframe}
\end{knitrout}
\end{figure}
